  ...
  <div class="container-widget">
    ...
    <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-6">
          <div class="panel panel-widget">
            <div class="panel-title">
              Notifications <span class="label label-default notifno"></span>
            </div>
            <div class="panel-body">

              <ul class="mailbox-inbox" id="messages" style="background: #282e3d">
              </ul>
        ...
        <div class="col-xs-6 col-sm-6 col-md-6">
          <div class="panel panel-widget">
            <div class="panel-title">
              <i class="fa fa-trophy" style="color:#f7c331"></i> Me Points
            </div>
            <div class="panel-body">
      ...
      <div class="row">
        <div class="col-sm-12 col-md-12">
          <div class="panel panel-widget">
            <div class="panel-title">
            <i class="fa fa-group color9"></i> Assigned Leads: <span class="color4 asgleads"></span> &nbsp &nbsp &nbsp ~ &nbsp &nbsp &nbsp <i class="fa fa-group color7"></i> Generated Leads: <span class="color4 genleads"></span>
            </div>
            <div class="panel-body">
