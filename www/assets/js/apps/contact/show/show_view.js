define(["app", "tpl!apps/templates/contact.tpl", "backbone.syphon"], 
	function(Ecommerce, contactTpl){
  Ecommerce.module('ContactApp.Show.View', function(View, Ecommerce, Backbone, Marionette, $, _){
  ...
  return Ecommerce.ContactApp.Show.View;
});
